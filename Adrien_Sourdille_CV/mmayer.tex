...
\begin{itemize}
\item 
Scoped, built, and automated a key financial report to track the company’s R\&D budget and spending using chained Alteryx apps, and delivered an interactive Tableau dashboard securely accessible on Tableau Server.
...
\begin{itemize}
\item Studying reinforcement learning, environmental economics, GIS and spatial data analysis
\item Answering causal research question and developing rigorous scientific method
\end{itemize}
...
\begin{minipage}[c]{0.08\linewidth}
  \includegraphics[width=\linewidth]{tableau-certified-data-analyst.1.png}
\end{minipage}%
\hspace{0.5em}%
...
\begin{minipage}[c]{0.08\linewidth}
  \includegraphics[width=\linewidth]{Snowpro-core (2).png}
\end{minipage}%
\hspace{0.5em}%
\begin{minipage}[c]{0.9\linewidth}
  \textbf{SnowPro Core}
...
\begin{minipage}[c]{0.08\linewidth}
  \includegraphics[width=\linewidth]{alteryx-designer-advanced-certification (1).png}
\end{minipage}%
\hspace{0.5em}%
\begin{minipage}[c]{0.9\linewidth}
...
\href{https://adriensourdilletil.github.io/AdrienSourdillePortfolio/}{\briefcase\ Visit my Portfolio Website}

\vspace{0.25cm} % Adjust the space as needed

\href{https://public.tableau.com/app/profile/adrien.sourdille4093/vizzes}{\homepage\ Visit my Tableau Public}
